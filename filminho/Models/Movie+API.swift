...
extension Movie {
    ...
    static let urlComponents = URLComponents(string: "https://api.themoviedb.org/")! //aqui a gente confiou
    ...
    static func popularMoviesAPI() async -> [Movie] {
        ...
        components.queryItems = [URLQueryItem(name: "api_key", value: Movie.apiKey)] // quando for manipular a API com mais dados eu mexo aqui!
